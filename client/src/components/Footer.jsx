...
const Footer = () => {
  return (
    <div className='bg-[#1d1d1d] w-[100%]   text-white font-bebasNeue xs:text-[6px] md:text-[1rem]'>
      ...
      <div className=' md:ml-[900px] md:mt-[70px] xs:ml-[180px] xs:mt-[35px] absolute right-[7vw] '>
      ...
      <div className='md:ml-[140px] md:mt-[70px] xs:ml-[30px] xs:mt-[35px] absolute right-[22vw]'>
      ...
      <div className='text-center mt-[5%] xs:text-[0.001em] text-white'><span>&#169;</span>COPYRIGHT 2023||ACPRODUCTIONS-ALL RIGHTS RESERVED</div>
    </div>
  )
}
