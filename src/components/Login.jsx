...
const Login = () => {
  ...
  return (
    <div className='bg-black md:h-[620px] xs:h-[532px]'>
      ...
      <div className=' bg-white text-black md:w-[720px] md:h-[440px] md:ml-[400px] md:pt-[80px] md:mt-[40px] shadow-md  xs:h-[380px]'>
      ...
      <div className='md:text-left xs:text-center'>
        ...
        <p className='md:ml-[200px] md:pl-[6px] md:mt-[15px] md:mr-[200px] xs:mt-[50px] xs:ml-[130px]'>Don't have an account? <NavLink to='/register' className='text-blue-400' >Register </NavLink> instead</p>
