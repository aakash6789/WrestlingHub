...
const Footer = () => {
  return (
    <div className='bg-[#1d1d1d]  flex text-white font-bebasNeue xs:text-[0.8rem] md:text-[1rem]xs:h-[100px]'>
      ...
      <div className='xs:bg-[#1d1d1d] absolute xs:mt-[95px] xs:ml-[0px] md:mt-[175px] md:ml-[540px] xs:h-[20px] xs:w-[502px] xs:pl-[133px]'><span>&#169;</span>COPYRIGHT 2023||ACPRODUCTIONS-ALL RIGHTS RESERVED</div>
    </div>
  )
}
