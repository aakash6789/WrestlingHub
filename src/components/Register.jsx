    ...
    <div className='md:h-[1200px] md:pt-[100px] text-white bg-black xs:h-[1000px]'>
      ...
      <div className='md:text-left xs:text-center'>
        ...
        <div className='md:text-left xs:text-center mt-[30px]'>
            ...
            <br/>
            <input id='name' name='lastName' type='text' className='xs:w-[386px] xs:h-[54px] xs:mt-[5px] md:ml-[30px] border-[4px] md:w-[660px] rounded-md md:h-[48px] md:mt-[5px] md:p-2' {...register("lastName")}/>
        </div>
