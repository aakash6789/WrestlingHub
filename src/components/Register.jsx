...
const Register = () => {
  ...
  return (
    <div className='md:h-[1200px] md:pt-[100px] text-white bg-black xs:pb-[50px]'>
      ...
      <div className=' bg-white text-black md:w-[720px] md:h-[830px] md:ml-[400px] md:pt-[80px] md:mt-[40px] shadow-md shadow-white'>
      ...
      <div className='md:text-left xs:text-center'>
        ...
        <p className='ml-[240px] pl-[6px] mt-[15px] mr-[240px]'>Have an account? <NavLink to='/login' className='text-blue-400' >Login </NavLink> instead</p>
        <button type="submit" className='bg-black text-white md:mt-[25px] md:w-[660px] md:ml-[30px] md:p-[0.45rem] font-bebasNeue hover:bg-black hover:text-yellow-200  '>Sign up</button>
      </form>
      </div>
    </div>
  )
